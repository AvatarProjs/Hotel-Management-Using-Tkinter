...
class PasswordRecoveryApp(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.show_new_password_btn = ctk.CTkButton(self.new_password_container,
                                                 ...
                                                 hover_color="#e0e0e0",
                                                 text_color="black",
                                                 command=lambda: self.toggle_password(self.new_password_entry, self.show_new_password_btn))
        ...
        ctk.CTkLabel(confirm_password_frame, text="Confirm Password:", font=("Arial", 12, "bold"), anchor="w").pack(anchor="w")
        ...
        self.show_confirm_password_btn = ctk.CTkButton(self.confirm_password_container,
                                                     ...
                                                     hover_color="#e0e0e0",
                                                     text_color="black",
                                                     command=lambda: self.toggle_password(self.confirm_password_entry, self.show_confirm_password_btn))
    ...
    def reset_password(self):
        ...
        if not self.validate_password(new_password):
            messagebox.showerror("Error", "Password must:\n• Be 8+ characters\n• Contain uppercase & lowercase\n• Contain a number\n• Contain a special character (!@#$)")
